...
- Pré-Análise do escopo requisitado
...
- Setup inicial do projeto (instalação de dependências e etc)
- Criação e organização das pastas e demais arquivos de configuração
- Correção de problemas de configuração como postcss, shadcn, etc

- Desenvolvimento da entrega dos produtos através das rotas `Products/` & `/Products/[id]`
